...
implements ActionListener {
    ...
    protected void addMenuRadioButton(String label, String groupName, boolean selected, Object receiver, String funcName) {
        ...
        JMenu menu = this.getMenu(names, names.length - 2);
        JRadioButtonMenuItem item = new JRadioButtonMenuItem(names[names.length - 1], selected);
    ...
    protected void addMenuRadioButton(String label, String groupName, boolean selected, String funcName) {
        this.addMenuRadioButton(label, groupName, selected, this, funcName);
    }
    ...
    protected void addRadioButton(String label, String groupName, boolean selected, Object receiver, String funcName, LayoutSpec layout) {
        ...
        this.frame.add((Component)item, layout.params);
    }
    ...
    private ButtonGroup getGroup(String name) {
        ButtonGroup g = this.buttonGroups.get(name);
        if (g == null) {
            g = new ButtonGroup();
